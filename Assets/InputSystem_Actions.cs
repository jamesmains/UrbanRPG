...
public partial class @InputSystemActions: IInputActionCollection2, IDisposable
{
    ...
    ~@InputSystemActions()
    {
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, InputSystemActions.Player.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputSystemActions.UI.Disable() has not been called.");
    }
