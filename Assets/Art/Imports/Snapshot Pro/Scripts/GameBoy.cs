...
namespace SnapshotShaders.BuiltIn {
    ...
    public class GameBoy : PostProcessEffectSettings {
        [Tooltip("Darkest colour.")] public ColorParameter darkest = new() {value = new Color(0.11f, 0.21f, 0.08f)};

        [Tooltip("Second darkest colour.")] public ColorParameter dark = new() {value = new Color(0.24f, 0.38f, 0.21f)};

        [Tooltip("Second lightest colour.")]
        public ColorParameter light = new() {value = new Color(0.57f, 0.67f, 0.21f)};

        [Tooltip("Lightest colour.")] public ColorParameter lightest = new() {value = new Color(0.75f, 0.82f, 0.46f)};
        ...
        public FloatParameter powerRamp = new() {value = 1.0f};
    }
