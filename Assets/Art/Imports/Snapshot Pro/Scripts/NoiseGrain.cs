...
namespace SnapshotShaders.BuiltIn {
    ...
    public sealed class NoiseGrain : PostProcessEffectSettings {
        ...
        public FloatParameter strength = new() {value = 0.1f};

        [Tooltip("How fast the noise grain changes values.")]
        public FloatParameter speed = new() {value = 1.0f};
        ...
        public NoiseInterpParameter noiseInterpolation = new() {value = NoiseInterpolation.Quintic};
    }
