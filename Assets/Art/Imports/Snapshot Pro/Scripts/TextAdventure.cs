...
namespace SnapshotShaders.BuiltIn {
    ...
    public class TextAdventure : PostProcessEffectSettings {
        ...
        public IntParameter characterSize = new() {value = 16};
        ...
        public TextureParameter characterAtlas = new();

        [Tooltip("How many characters are contained in the Character Atlas.")]
        public IntParameter characterCount = new() {value = 16};

        [Tooltip("The color of the background.")]
        public ColorParameter backgroundColor = new() {value = Color.black};

        [ColorUsage(true, true)] [Tooltip("The color of the characters superimposed onto the background.")]
        public ColorParameter characterColor = new() {value = Color.green};
    }
