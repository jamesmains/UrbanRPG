...
public class MessageBox : MonoBehaviour
{
    ...
    [SerializeField,FoldoutGroup("Objects")] private GameObject buttonObject;
    [SerializeField,FoldoutGroup("Objects")] private GameObject horizontalFiller;
    [SerializeField,FoldoutGroup("Objects")] private GameObject verticalFiller;
    ...
    public static TMP_InputField AddInputField(string placeholderText, float displayLength = 250f, UnityAction onSubmit = null, UnityAction onTextChanged = null)
    {
    ...
    {
        Instantiate(Instance.horizontalFiller, Instance.currentLine).transform.GetChild(0).GetComponent<RectTransform>().sizeDelta = new Vector2(space,0);
    }

    public static void VerticalSpace(float space)
    {
        Instantiate(Instance.verticalFiller, Instance.window).GetComponent<RectTransform>().sizeDelta = new Vector2(0,space);
        NewLine();
    }
