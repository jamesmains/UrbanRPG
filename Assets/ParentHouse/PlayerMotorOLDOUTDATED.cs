...
namespace ParentHouse {
    public class PlayerMotorOLDOUTDATED : MonoBehaviour {
        ...
        [FoldoutGroup("Data")] [SerializeField]
        public ModdableFloat moveSpeed; // might be replaced with scriptable object float variable 
        ...
        private void Awake() {
            Global.PlayerLock = 0;
            if (playerSaveSlot.NextSceneTransition != null &&
                !string.IsNullOrEmpty(playerSaveSlot.NextSceneTransition.TargetScene))
        ...
        private void FixedUpdate() {
            ...
            ;
            var isMoving = inputX != 0 || inputY != 0;
