...
namespace ParentHouse {
    public class QuestDisplay : FoldoutDisplay {
        ...
        public void UpdateDisplay() {
            ...
            var questTask = heldQuest.GetCurrentQuestTask();
            ...
            heldQuestDescription =
                hidden ? "I could have sworn there was something I was supposed to do..." : heldQuestDescription;
